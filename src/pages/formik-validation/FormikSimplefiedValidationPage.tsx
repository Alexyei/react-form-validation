...
const FormikSimplifiedValidationPage = (props: any) => {
    ...
    return (
        <Formik initialValues={initialValues} validate={validate} onSubmit={onSubmit}>
            {formik => (
                <UniversalRoundedForm formElement={<Form></Form>}  header={header} {...props}>

                    {fields.map((field, index) =>
                        <RoundedInput onChange={formik.handleChange} onBlur={formik.handleBlur} value={(formik.values as any)[field.name]} key={index}
                                      errorText={(formik.touched as any)[field.name] && (formik.errors as any)[field.name]} {...field}></RoundedInput>
                    )}
...
export default FormikSimplifiedValidationPage;